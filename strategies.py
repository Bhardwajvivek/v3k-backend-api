# strategies.py – Enhanced for Equity + Option Signals with Max Pain and PCR
...
from option_chain_utils import get_option_signals  # updated util for signals + max pain
...
# ✅ Updated with default fallback symbols/timeframes
def scan_symbols_enhanced(symbols=None, timeframes=None):
    ...
    if not symbols:
        symbols = [
            ...
            "HDFCBANK.NS", "SBIN.NS", "AXISBANK.NS", "LT.NS",
            "ITC.NS", "KOTAKBANK.NS", "MARUTI.NS"
        ]
    if not timeframes:
