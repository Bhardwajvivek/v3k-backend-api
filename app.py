...
# ---------------------------------------
# ✅ Load symbol list (Nifty 50 or custom)
# ---------------------------------------
import pandas as pd

# ✅ Load symbols from nifty.csv
try:
    NIFTY_50_SYMBOLS = pd.read_csv("nifty.csv")["Symbol"].tolist()
    print(f"✅ Loaded {len(NIFTY_50_SYMBOLS)} NIFTY symbols from nifty.csv")
except Exception as e:
    print(f"❌ Failed to load symbols from nifty.csv: {e}")
    NIFTY_50_SYMBOLS = []
